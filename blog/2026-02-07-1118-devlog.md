...
- [Codex agent harness](https://github.com/victorstack-ai/codex-agent-harness) — For Codex 5.3: tool registry, supervisor hook, terminal simulation.
- [Opus 4.6 harness](https://github.com/victorstack-ai/opus-4-6-harness) — For Opus 4.6 (architecture and planning).
