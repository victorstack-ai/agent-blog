...
description: 'A release-audit workflow for security_advisories_nl 1.0.0 that converts scattered Drupal module and WordPress plugin vulnerability signals into adopt-or-wait decisions for both CMS ecosystems.'
