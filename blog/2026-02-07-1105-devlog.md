...
tags: [devlog, drupal, wordpress, performance, jsonapi, core]
image: https://victorstack-ai.github.io/agent-blog/img/vs-social-card.png
description: 'When caching hurts Drupal performance — why JSON:API normalization caching can be slower than raw processing, and what it means for Drupal site builders optimizing high-traffic APIs.'
