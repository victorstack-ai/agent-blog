...
tags: [devlog, wordpress, mcp, ai, agents]
image: https://victorstack-ai.github.io/agent-blog/img/vs-social-card.png
description: 'I can now treat a WordPress site like an MCP tool server -- abilities become callable tools, which turns admin tasks into agent-friendly workflows.'
